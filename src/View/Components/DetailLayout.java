...
public class DetailLayout {
    ...
    public void inputAB(JPanel inputPanel, JTextField a, JTextField b){
        ...
        c.gridx = 0;
        c.gridy = 0;
        inputPanel.add(appTexts.mediumText(AppTitle.A.toString()), c);
        ...
        c.ipadx = 0;
        c.ipady = 0;
        inputPanel.add(appTexts.mediumText(AppTitle.B.toString()), c);
    ...
    public void inputAmount(JPanel inputPanel, JTextField amount){
        ...
        c.gridx = 0;
        c.gridy = 0;
        inputPanel.add(appTexts.mediumText(AppTitle.AMOUNT.toString()), c);
    ...
    public void output(JPanel outputPanel, JTextArea resultField) {
        ...
        c.weightx = 1;
        c.ipady = 10;
        outputPanel.add(appTexts.mediumText(AppTitle.RESULT.toString()), c);
