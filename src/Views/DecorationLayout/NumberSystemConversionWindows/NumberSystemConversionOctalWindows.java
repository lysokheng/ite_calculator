...
import Views.Widgets.NumberSystemConversionWidgets.NumberSystemConversionOctalWidgets;

import javax.swing.*;
import java.awt.*;

public class NumberSystemConversionOctalWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    NumberSystemConversionOctalWidgets numberSystemConversionOctalWidgets = new NumberSystemConversionOctalWidgets();
    ...
    public JPanel numberSystemConversionOctalPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionOctalWidgets.numberSystemConversionOperator(), c);
        ...
        c.gridx = 3;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionOctalWidgets.numberSystemConversionInput(), c);
        ...
        c.gridx = 3;
        c.gridy = 4;
        mainPanel.add(numberSystemConversionOctalWidgets.numberSystemConversionOutput(), c);
        ...
        c.gridx = 4;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionOctalWidgets.numberSystemConversionHistory(), c);
        ...
        c.gridx = 3;
        c.gridy = 5;
        mainPanel.add(numberSystemConversionOctalWidgets.numberSystemConversionReset(), c);
