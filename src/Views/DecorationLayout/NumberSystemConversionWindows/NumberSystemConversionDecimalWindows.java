...
import Views.Routes;
import Views.Widgets.NumberSystemConversionWidgets.NumberSystemConversionDecimalWidgets;
...
public class NumberSystemConversionDecimalWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    NumberSystemConversionDecimalWidgets numberSystemConversionDecimalWidgets = new NumberSystemConversionDecimalWidgets();
    ...
    public JPanel numberSystemConversionDecimalPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionDecimalWidgets.numberSystemConversionOperator(), c);
        ...
        c.gridx = 3;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionDecimalWidgets.numberSystemConversionInput(), c);
        ...
        c.gridx = 3;
        c.gridy = 4;
        mainPanel.add(numberSystemConversionDecimalWidgets.numberSystemConversionOutput(), c);
        ...
        c.gridx = 4;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionDecimalWidgets.numberSystemConversionHistory(), c);
        ...
        c.gridx = 3;
        c.gridy = 5;
        mainPanel.add(numberSystemConversionDecimalWidgets.numberSystemConversionReset(), c);
