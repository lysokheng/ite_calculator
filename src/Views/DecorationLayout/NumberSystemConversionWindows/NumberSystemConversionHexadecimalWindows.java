...
import Views.Widgets.NumberSystemConversionWidgets.NumberSystemConversionHexadecimalWidgets;

import javax.swing.*;
import java.awt.*;

public class NumberSystemConversionHexadecimalWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    NumberSystemConversionHexadecimalWidgets numberSystemConversionHexadecimalWidgets = new NumberSystemConversionHexadecimalWidgets();
    ...
    public JPanel numberSystemConversionHexadecimalPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionHexadecimalWidgets.numberSystemConversionOperator(), c);
        ...
        c.gridx = 3;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionHexadecimalWidgets.numberSystemConversionInput(), c);
        ...
        c.gridx = 3;
        c.gridy = 4;
        mainPanel.add(numberSystemConversionHexadecimalWidgets.numberSystemConversionOutput(), c);
        ...
        c.gridx = 4;
        c.gridy = 3;
        mainPanel.add(numberSystemConversionHexadecimalWidgets.numberSystemConversionHistory(), c);
        ...
        c.gridx = 3;
        c.gridy = 5;
        mainPanel.add(numberSystemConversionHexadecimalWidgets.numberSystemConversionReset(), c);
