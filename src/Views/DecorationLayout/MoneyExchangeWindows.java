...
import Views.Routes;
import Views.Widgets.MoneyExchangeWidgets;
...
public class MoneyExchangeWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    MoneyExchangeWidgets moneyExchangeWidgets = new MoneyExchangeWidgets();
    ...
    public JPanel moneyExchangePanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(moneyExchangeWidgets.moneyExchangeOperator(), c);
        ...
        c.gridx = 1;
        c.gridy = 3;
        mainPanel.add(moneyExchangeWidgets.moneyExchangeInput(), c);
        ...
        c.gridx = 1;
        c.gridy = 4;
        mainPanel.add(moneyExchangeWidgets.moneyExchangeOutput(), c);
        ...
        c.gridx = 2;
        c.gridy = 3;
        mainPanel.add(moneyExchangeWidgets.moneyExchangeHistory(), c);
        ...
        c.gridx = 1;
        c.gridy = 5;
        mainPanel.add(moneyExchangeWidgets.moneyExchangeReset(), c);
