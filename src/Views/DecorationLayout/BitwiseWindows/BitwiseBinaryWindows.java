...
import Views.Widgets.BitwiseWidgets.BitwiseBinaryWidgets;

import javax.swing.*;
import java.awt.*;

public class BitwiseBinaryWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    BitwiseBinaryWidgets bitwiseBinaryWidgets = new BitwiseBinaryWidgets();
    ...
    public JPanel bitwisePanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(bitwiseBinaryWidgets.bitwiseOperator(), c);
        ...
        c.gridx = 1;
        c.gridy = 3;
        mainPanel.add(bitwiseBinaryWidgets.bitwiseInput(), c);
        ...
        c.gridx = 1;
        c.gridy = 4;
        mainPanel.add(bitwiseBinaryWidgets.bitwiseOutput(), c);
        ...
        c.gridx = 2;
        c.gridy = 3;
        mainPanel.add(bitwiseBinaryWidgets.bitwiseHistory(), c);
        ...
        c.gridx = 1;
        c.gridy = 5;
        mainPanel.add(bitwiseBinaryWidgets.bitwiseReset(), c);
