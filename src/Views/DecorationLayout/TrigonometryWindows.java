...
import Views.Routes;
import Views.Widgets.TrigonometryWidgets;
...
public class TrigonometryWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    TrigonometryWidgets trigonometryWidgets = new TrigonometryWidgets();
    ...
    public JPanel trigonometryPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(trigonometryWidgets.trigonometryOperator(), c);
        ...
        c.gridx = 1;
        c.gridy = 3;
        mainPanel.add(trigonometryWidgets.trigonometryInput(), c);
        ...
        c.gridx = 1;
        c.gridy = 4;
        mainPanel.add(trigonometryWidgets.trigonometryOutput(), c);
        ...
        c.gridx = 2;
        c.gridy = 3;
        mainPanel.add(trigonometryWidgets.trigonometryHistory(), c);
        ...
        c.gridx = 1;
        c.gridy = 5;
        mainPanel.add(trigonometryWidgets.trigonometryReset(), c);
