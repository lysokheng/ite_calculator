...
import Views.Routes;
import Views.Widgets.BinaryArithmeticWidgets;
...
public class BinaryArithmeticWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    BinaryArithmeticWidgets binaryArithmeticWidgets = new BinaryArithmeticWidgets();
    ...
    public JPanel binaryArithmeticPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(binaryArithmeticWidgets.BinaryArithmeticOperator(), c);
        ...
        c.gridx = 1;
        c.gridy = 3;
        mainPanel.add(binaryArithmeticWidgets.BinaryArithmeticInput(), c);
        ...
        c.gridx = 1;
        c.gridy = 4;
        mainPanel.add(binaryArithmeticWidgets.BinaryArithmeticOutput(), c);
        ...
        c.gridx = 2;
        c.gridy = 3;
        mainPanel.add(binaryArithmeticWidgets.BinaryArithmeticHistory(), c);
        ...
        c.gridx = 1;
        c.gridy = 5;
        mainPanel.add(binaryArithmeticWidgets.BinaryArithmeticReset(), c);
