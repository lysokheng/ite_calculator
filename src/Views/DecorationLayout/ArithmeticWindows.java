...
public class ArithmeticWindows {
    ...
    public JPanel arithmeticPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(arithmeticWidgets.arithmeticOperator(), c);
        ...
        c.gridx = 1;
        c.gridy = 3;
        mainPanel.add(arithmeticWidgets.arithmeticInput(), c);
        ...
        c.gridx = 1;
        c.gridy = 4;
        mainPanel.add(arithmeticWidgets.arithmeticOutput(), c);
        ...
        c.gridx = 2;
        c.gridy = 3;
        mainPanel.add(arithmeticWidgets.arithmeticHistory(), c);
        ...
        c.gridx = 1;
        c.gridy = 5;
        mainPanel.add(arithmeticWidgets.arithmeticReset(), c);
