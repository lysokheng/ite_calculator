...
import Views.Routes;
import Views.Widgets.SetTheoryWidgets;
...
public class SetTheoryWindows {

    AppColors appColors = new AppColors();
    AppTexts appTexts = new AppTexts();
    Routes routs = new Routes();
    SetTheoryWidgets setTheoryWidgets = new SetTheoryWidgets();
    ...
    public JPanel setTheoryPanel(JFrame frame) {
        ...
        c.gridx = 0;
        c.gridy = 3;
        mainPanel.add(setTheoryWidgets.setTheoryOperator(), c);
        ...
        c.gridx = 1;
        c.gridy = 3;
        mainPanel.add(setTheoryWidgets.setTheoryInput(), c);
        ...
        c.gridx = 1;
        c.gridy = 4;
        mainPanel.add(setTheoryWidgets.setTheoryOutput(), c);
        ...
        c.gridx = 2;
        c.gridy = 3;
        mainPanel.add(setTheoryWidgets.setTheoryHistory(), c);
        ...
        c.gridx = 1;
        c.gridy = 5;
        mainPanel.add(setTheoryWidgets.setTheoryReset(), c);
