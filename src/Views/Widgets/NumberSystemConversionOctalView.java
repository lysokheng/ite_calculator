...
import Controller.NumberSystemConversionOctalController;
...
public class NumberSystemConversionOctalView {
    //create object
    ...
    NumberSystemConversionOctalController numberSystemConversionOctalController = new NumberSystemConversionOctalController();
    ...
    public JPanel numberSystemConversionHistory() {
        ...
        //perform calculate
        numberSystemConversionOctalController.octal2DecimalResult(octalToDecimalButton, amount, resultField, historyField);
        numberSystemConversionOctalController.octal2BinaryResult(octalToBinaryButton, amount, resultField, historyField);
        numberSystemConversionOctalController.octal2HexResult(octalToHexadecimalButton, amount, resultField, historyField);

        return historyPanel;
    }

    public JButton numberSystemConversionReset(){
        numberSystemConversionOctalController.performReset(resetButton, amount, resultField, historyField);
        return resetButton;
    }
}
