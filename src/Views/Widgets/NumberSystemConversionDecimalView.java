...
import Controller.NumberSystemConversionDecimalController;
...
public class NumberSystemConversionDecimalView {
    //create object
    ...
    NumberSystemConversionDecimalController numberSystemConversionDecimalController = new NumberSystemConversionDecimalController();
    ...
    public JPanel numberSystemConversionHistory() {
        ...
        //perform calculate
        numberSystemConversionDecimalController.dec2BinaryResult(decimalToBinaryButton, amount, resultField, historyField);
        numberSystemConversionDecimalController.dec2HexaResult(decimalToHexadecimalButton, amount, resultField, historyField);
        numberSystemConversionDecimalController.dec2OctalResult(decimalToOctalButton, amount, resultField, historyField);

        return historyPanel;
    }

    public JButton numberSystemConversionReset(){
        numberSystemConversionDecimalController.performReset(resetButton, amount, resultField, historyField);
        return resetButton;
    }
}
