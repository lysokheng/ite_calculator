...
import Controller.SetTheoryCalculation;
...
public class SetTheoryWidgets{
    ...
    SetTheoryCalculation setTheoryCalculation = new SetTheoryCalculation();
    ...
    public JPanel setTheoryHistory() {
        ...
        //perform calculate
        setTheoryCalculation.unionResult(unionButton, a, b, resultField, historyField);
        setTheoryCalculation.intersectionResult(intersectionButton, a, b, resultField, historyField);
        setTheoryCalculation.differenceResult(differenceButton, a, b, resultField, historyField);

        return historyPanel;
    }

    public JButton setTheoryReset(){
        setTheoryCalculation.performReset(resetButton, a, b, resultField, historyField);
        return resetButton;
    }
