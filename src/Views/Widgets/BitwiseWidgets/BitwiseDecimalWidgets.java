...
import Controller.BitwiseCalculation.BitwiseDecimalCalculation;
...
public class BitwiseDecimalWidgets {
    //create object
    ...
    BitwiseDecimalCalculation bitwiseDecimalCalculation = new BitwiseDecimalCalculation();
    ...
    public JPanel bitwiseHistory() {
        ...
        //perform calculate
        bitwiseDecimalCalculation.bitwiseANDResult(bitwiseANDButton, a, b, resultField, historyField);
        bitwiseDecimalCalculation.bitwiseORResult(bitwiseORButton, a, b, resultField, historyField);
        bitwiseDecimalCalculation.bitwiseXORResult(bitwiseXORButton, a, b, resultField, historyField);
        bitwiseDecimalCalculation.bitwiseLeftShiftResult(bitwiseLeftShiftButton, a, b, resultField, historyField);
        bitwiseDecimalCalculation.bitwiseRightShiftResult(bitwiseRightShiftButton, a, b, resultField, historyField);
        bitwiseDecimalCalculation.bitwiseInversionResult(bitwiseInversionButton, a, resultField, historyField);

        return historyPanel;
    }

    public JButton bitwiseReset(){
        bitwiseDecimalCalculation.performReset(resetButton, a, b, resultField, historyField);
        return resetButton;
    }
