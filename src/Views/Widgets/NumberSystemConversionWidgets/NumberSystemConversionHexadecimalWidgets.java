...
import Controller.NumberSystemConversionCalculation.NumberSystemConversionHexadecimalCalculation;
...
public class NumberSystemConversionHexadecimalWidgets {
    //create object
    ...
    NumberSystemConversionHexadecimalCalculation numberSystemConversionHexadecimalCalculation = new NumberSystemConversionHexadecimalCalculation();
    ...
    public JPanel numberSystemConversionHistory() {
        ...
        //perform calculate
        numberSystemConversionHexadecimalCalculation.hex2DecimalResult(hexadecimalToDecimalButton, amount, resultField, historyField);
        numberSystemConversionHexadecimalCalculation.hex2BinaryResult(hexadecimalToBinaryButton, amount, resultField, historyField);
        numberSystemConversionHexadecimalCalculation.hex2OctalResult(hexadecimalToOctalButton, amount, resultField, historyField);

        return historyPanel;
    }

    public JButton numberSystemConversionReset(){
        numberSystemConversionHexadecimalCalculation.performReset(resetButton, amount, resultField, historyField);
        return resetButton;
    }
}
