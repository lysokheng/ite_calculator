...
import Controller.TrigonometryCalculation;
...
public class TrigonometryWidgets{
    //create object
    ...
    TrigonometryCalculation trigonometryCalculation = new TrigonometryCalculation();
    ...
    public JPanel trigonometryHistory() {
        ...
        //perform calculate
        trigonometryCalculation.sinToRadianResult(sinToRadianButton, amount, resultField, historyField);
        trigonometryCalculation.sinToDegreeResult(sinToDegreeButton, amount, resultField, historyField);
        trigonometryCalculation.cosToDegreeResult(cosToDegreeButton, amount, resultField, historyField);
        trigonometryCalculation.cosToRadianResult(cosToRadianButton, amount, resultField, historyField);
        trigonometryCalculation.tanToDegreeResult(tanToDegreeButton, amount, resultField, historyField);
        trigonometryCalculation.tanToRadianResult(tanToRadianButton, amount, resultField, historyField);
        trigonometryCalculation.degreeToRadianResult(degreeToRadianButton, amount, resultField, historyField);
        trigonometryCalculation.square2InIntResult(square2InIntegerButton, amount, resultField, historyField);
        trigonometryCalculation.square2InFloating_pointResult(square2InFloatingPointButton, amount, resultField, historyField);
        trigonometryCalculation.square3InIntResult(square3InIntegerButton, amount, resultField, historyField);
        trigonometryCalculation.square3InFloating_pointResult(square3InFloatingPointButton, amount, resultField, historyField);

        return historyPanel;
    }

    public JButton trigonometryReset(){
        trigonometryCalculation.performReset(resetButton, amount, resultField, historyField);
        return resetButton;
    }
